                  ...
                  child: new Column(
                    children: <Widget>[
                      new Card(
                        ...
                        child: new Container(
                          color: Color(0x00000000),
                          child: new Text((show) ? (widget.player.isAlive == 0) ? "ELIMINÉ" : enemy.name : "? ? ?",
                      ...
                      new Card(
                        ...
                        child: new Container(
                          color: Color(0x00000000),
                          child: new Text((show) ? (widget.player.isAlive == 0) ? "TU ES ELIMINÉ" : widget.player.pledge : "? ? ? ? ? ? ?",
                            textAlign: TextAlign.center,
                            textScaleFactor: 2,
                            style: TextStyle(
                                color: Colors.white
